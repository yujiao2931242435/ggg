...
<%@page import="com.lyq.bean.Lesson"%>
<html>
<head>
		...
		<tr align="center" bgcolor="#e1ffc1" >
			...
			%>
				<tr align="center" bgcolor="white">
					<td><h3><%=lesson.getName()%></h3></td>
					<td><h3><%=lesson.getId()%></h3></td>
					<td><h3><%=lesson.getSex()%></h3></td>
					<td><h3><%=lesson.getLesson()%></h3></td>
				    <td><h3><%=lesson.getLesson1()%></h3></td>
					<td><h3><%=lesson.getLesson2()%></h3></td>
